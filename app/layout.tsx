  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col" style={{ background: "var(--bg)", color: "var(--text)" }}>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){try{var t=JSON.parse(localStorage.getItem('lypx_last_theme')||'null');if(!t)return;var d=document.documentElement;var dk={"--bg-primary":"#0a0a0a","--bg-secondary":"#111111","--text-primary":"#ffffff","--text-secondary":"#8a8a93","--menu-bg":"#1a1a1a","--menu-text":"#ffffff","--bg":"#0a0a0a","--surface":"#1b1b1f","--surface-raised":"#202024","--border":"#2c2c35","--text":"#ffffff","--text-dim":"#8a8a93","--text-faint":"#55555e"};var lk={"--bg-primary":"#ffffff","--bg-secondary":"#f5f5f5","--text-primary":"#0a0a0a","--text-secondary":"#555560","--menu-bg":"#f0f0f0","--menu-text":"#0a0a0a","--bg":"#ffffff","--surface":"#f5f5f7","--surface-raised":"#ebebef","--border":"#e0e0e8","--text":"#0a0a0f","--text-dim":"#555560","--text-faint":"#999999"};var tok=t.bg==='light'?lk:dk;for(var k in tok)d.style.setProperty(k,tok[k]);if(t.accent){d.style.setProperty('--accent',t.accent);d.style.setProperty('--accent-color',t.accent);d.style.setProperty('--primary',t.accent);}}catch(e){}})()` }} />
        {children}
      </body>
    </html>
  );
